...
urlpatterns = [
    ...
    path(
        "update/<int:pk>/", views.StockItemUpdateView.as_view(), name="stockitem_update"
    ),
    ...
    path(
        "department/list/",
        views.StockDepartmentListView.as_view(),
        name="department_list",
    ),
    path(
        "delete/<int:pk>/", views.StockItemDeleteView.as_view(), name="stockitem_delete"
    ),
]
