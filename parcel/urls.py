...
urlpatterns = [
    ...
    path(
        ...
        include(
            [
                ...
                path("request_bill/<int:pk>/", views.request_bill, name="request_bill"),
            ]
        ),
    ),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "recieve_item/<int:pk>/",
                    views.RecieveItemsView.as_view(),
                    name="recieve_item",
                ),
                path(
                ...
                path(
                    "replace_item/",
                    views.ReplaceItemLocationView.as_view(),
                    name="replace_item",
                ),
                path(
                ...
                path(
                    "draft_list/",
                    views.ParcelReturnDraftListView.as_view(),
                    name="draft_list",
                ),
                path(
                    "location_list/",
                ...
                path(
                    "remove_item/", views.RemoveItemView.as_view(), name="remove_item"
                ),
            ]
        ),
    ),
    ...
    path(
        ...
        include(
            [
                path("list/", views.BillManagerListView.as_view(), name="manager_list"),
                path(
                    "wait_approve/",
                ...
                path(
                    "request_approve/<int:pk>/",
                    views.request_approve,
                    name="request_approve",
                ),
                path(
                    "set_serial_item/<int:pk>/",
                    views.set_serial_item,
                    name="set_serial_item",
                ),
                path(
                    "paid_item/<int:pk>/",
                    views.PaidItemView.as_view(),
                    name="paid_item",
                ),
                path(
                    "parcel/return/list/",
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "approve_return/<int:pk>/",
                    views.return_approve,
                    name="return_approve",
                ),
                path(
                    "control_return/<int:pk>/",
                    views.return_controler,
                    name="return_controler",
                ),
                path(
                    "return_done/<int:pk>/",
                    views.return_done,
